...
public class PurchaseHistoryAdapter extends BaseAdapter {
    ...
    ArrayList<PurchaseHistory> productList;
    Context context;

    public PurchaseHistoryAdapter(ArrayList<PurchaseHistory> productList, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        productQuantityText.setText(String.valueOf(this.productList.get(i).getQuantity()));
        productPriceText.setText(String.format(context.getResources().getString(R.string.dollar_amount), this.productList.get(i).getTotalPrice()));
